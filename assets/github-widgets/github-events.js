...
(function (factory) {
    ...
    $.widget('radic.githubEvents', $.github.widget, /** @lends radic.githubEvents */ {
         ...
         * @property {object} [options.output.events.IssueCommentEvent]
         * @property {object} [options.output.events.IssuesEvent]
         * @property {object} [options.output.events.MemberEvent]
         * @property {object} [options.output.events.PageBuildEvent]
         * @property {object} [options.output.events.PublicEvent]
         * @property {object} [options.output.events.PullRequestEvent]
         * @property {object} [options.output.events.PullRequestReviewCommentEvent]
         * @property {object} [options.output.events.PushEvent]
         * @property {object} [options.output.events.ReleaseEvent]
         * @property {object} [options.output.events.StatusEvent]
         * @property {object} [options.output.events.TeamAddEvent]
         * @property {object} [options.output.events.WatchEvent]
         * @example
